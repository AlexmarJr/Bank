    ...
    <div class="col-6">
        <div class="info-box bg-success">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">R$: {{number_format((int)Auth::user()->balance / 100, 2, ',', '.') }} <button class="btn btn-success" onclick="add_found()">+ 1000 R$</button></span> 
              <div class="progress">
    ...
    <div class="col-6">
        <div class="info-box bg-gradient-warning">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{number_format((int)Auth::user()->stocks / 100, 2, ',', '.') }}</span>
              <div class="progress">
                <div class="progress-bar" style="width: 70%"></div>
              </div>
                <span class="progress-description">
